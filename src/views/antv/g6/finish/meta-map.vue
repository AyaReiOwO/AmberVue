...
const initTree = ()=> {
  ...
  registerEdge("dice-er-edge", {
    draw(cfg, group) {
      ...
      if(sourceNode.showTitle  ){
        sourceY += 86;
      }else if(sourceNode.titleBox === '当' ){
        sourceY += 12;
      }
      ...
      if(targetNode.showTitle  ){
        targetY += 86;
      }else if(targetNode.titleBox === '当' ){
        targetY += 12;
      }
      ...
      if (sourceNode.id !== targetNode.id) {
        shape = group.addShape("path", {
          attrs: {
            ...
            stroke: `l(0) 0:${sourceNode.mainColor}40  1:${targetNode.mainColor}90 `,
            lineWidth: 2,
            endArrow: false,
          },
          type: 'circle-running',
    ...
    afterDraw(cfg, group) {
      ...
      //         // get the position on the edge according to the ratio
      //         const tmpPoint = shape.getPoint(ratio);
      //         const pos = G6.getLabelPosition(shape, ratio);
      //         let matrix = [1, 0, 0, 0, 1, 0, 0, 0, 1];
      //         matrix = G6.transform(matrix, [
      ...
      if (showTitle ) {
        ...
        group.addShape("rect", {
          attrs: {
            ...
            shadowColor:'rgba(27,43,115,0.1000)',
            shadowBlur:10,
          },
          draggable: true,
        });
      ...
      if(titleBox === '当'){
        ...
        group.addShape("image", {
          attrs: {
            ...
            height: 20,
            width: 14,
            img:'data:image/png;base64,',
          },
          draggable: true,
        });
      }
