    ...
    G6.registerNode(
      'lineNode',
      {
        ...
        draw(cfg, group) {
          ...
          image.animate(
            ratio => {
              const toMatrix = G6.Util.transform([0, 1, 1, 1, 0, 1, 1, 1, 0], [['r', ratio * Math.PI * 2]]);
              return {
                matrix: toMatrix
              };
            },
            ...
            values.forEach((value, index) => {
...

              {
...

                {
                  ...
                  endPoint.x = endPoint.x * 0.8;

                  const controlPoint = [startPoint.x * 0.25 + endPoint.x * 0.75, startPoint.y];
                  const controlPoint2 = [startPoint.x * 0.5 + endPoint.x * 0.5, endPoint.y];
                  ...
                  if (index < 6) {
                      ...
                      group.addShape('path', {
                        attrs: {
                          ...
                          path: [
                            ...
                            ['C', ...controlPoint2, ...controlPoint, startPoint.x, startPoint.y]
                          ],
                          cursor: 'pointer'
                        },
                      ...
                      group.addShape('path', {
                        attrs: {
                          ...
                          path: [
                            ...
                            ['C', ...controlPoint, ...controlPoint2, endPoint.x, endPoint.y]
                          ],
                          cursor: 'pointer'
                        },
                        name: `path-shape${index}`
                    ...
                    group.addShape('path', {
                      attrs: {
                        stroke: startPoint.x > 0 ? `l(0) 0:${value.mainColor}  1:${value.mainColor} ` : `l(0) 0:${value.mainColor}  1:${value.mainColor} `,
                        lineWidth: 18,
                        path: [
                          ['M', startPoint.x, startPoint.y],
